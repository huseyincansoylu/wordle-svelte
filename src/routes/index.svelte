...
<main class="flex flex-col items-center min-h-[calc(100vh-3rem)]">
    ...
    {#if $gameOver}
       <div transition:fade class="bg-white text-black z-10 rounded-lg absolute w-[520px] h-[420px] shadow-3xl translate-y-[20%] p-4 flex flex-col items-center justify-evenly">
      ...
      <div class="rounded-sm w-[250px] h-[250px]">
       ...
       {:else}
        <div class="text-2xl">THE WORD WAS</div>
        <div class="text-2xl">"{$GAME_WORD}"</div>
    {/if}
